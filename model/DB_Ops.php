...
Class Database{
  ...
  function __construct($server_name,$name,$pass,$database_name){
  ...
  function connect(){
    $conn= mysqli_connect($this->server_name, $this->name, $this->pass)
     or die("Could not connect: " . mysqli_error($conn));


  //select database 
  mysqli_select_db($conn , $this->database_name) 
